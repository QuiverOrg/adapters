...
import '../detectors/serinus_detector.dart';
...
class SerinusAdapter extends QuiverAdapter with AdapterHelpers {
  @override
  String get name => 'serinus';
  @override
  String get displayName => 'Serinus';
  @override
  FrameworkDetector get detector => SerinusDetector();
  ...
  Future<BuildOutput> build(BuildContext context) async {
    ...
    final output = BuildOutput(
      framework: FrameworkInfo(
        name: 'serinus',
        version: PubspecUtils.getDependencyVersion(pubspec, 'serinus'),
      ),
      dart: DartInfo(
